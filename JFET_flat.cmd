...
(sdegeo:create-cuboid (position 0 5 CNT_d) (position 40 35 (+ CNT_d 0.7)) "Moly" "Gate" ) ; MoS2 gate

(sdegeo:create-cuboid (position 0 5 CNT_d) (position 10 35 (+ CNT_d 0.7)) "Moly" "Gate_Electrode") ; MoS2 gate region
...
(sdegeo:define-3d-contact(list(car(find-face-id (position 5 20 (+ CNT_d 0.7) ))))"G")
